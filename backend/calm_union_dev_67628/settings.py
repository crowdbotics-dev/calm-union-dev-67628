"""
Django settings for calm_union_dev_67628 project.
...
ROOT_URLCONF = 'calm_union_dev_67628.urls'
...
WSGI_APPLICATION = 'calm_union_dev_67628.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_union_dev_67628 API",
    "DESCRIPTION": "API documentation for calm_union_dev_67628 App",
    "VERSION": "v1",
}
